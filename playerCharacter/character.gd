...
# @onready variables go at the very bottom
...
func _physics_process(delta: float) -> void:
	...
	move(delta)
	update_camera()  # Removed unused delta
	move_and_slide()
...
func move(delta: float) -> void:
	...
	# Updated to match your "move_sprint" action name
...
func set_pos(new_pos: Vector3) -> void:
	self.global_position = new_pos  # Updated to use global_position
